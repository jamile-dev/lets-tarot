...
func DefaultCards() []Card {
	cards := []Card{
		...
		// ---- COPAS (Cups) - Emoções, relacionamentos, intuição ----
		{
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu01.jpg",
		},
		{
			ID:           "cu02",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu02.jpg",
		},
		{
			ID:           "cu03",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu03.jpg",
		},
		{
			ID:           "cu04",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu04.jpg",
		},
		{
			ID:           "cu05",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu05.jpg",
		},
		{
			ID:           "cu06",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu06.jpg",
		},
		{
			ID:           "cu07",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu07.jpg",
		},
		{
			ID:           "cu08",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu08.jpg",
		},
		{
			ID:           "cu09",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu09.jpg",
		},
		{
			ID:           "cu10",
			NamePT:       "Dez de Copas",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cu10.jpg",
		},
		// Copas — Cavaliere (Page)
		{
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/cunk.jpg",
		},
		// Copas — Rei
		{
			ID:           "curk",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/curk.jpg",
		},
		// Copas — Rainha
		{
			ID:           "curq",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/curq.jpg",
		},
		// ---- ESPADAS (Swords) - Intelecto, conflito, verdades ----
		{
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es01.jpg",
		},
		{
			ID:           "es02",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es02.jpg",
		},
		{
			ID:           "es03",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es03.jpg",
		},
		{
			ID:           "es04",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es04.jpg",
		},
		{
			ID:           "es05",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es05.jpg",
		},
		{
			ID:           "es06",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es06.jpg",
		},
		{
			ID:           "es07",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es07.jpg",
		},
		{
			ID:           "es08",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es08.jpg",
		},
		{
			ID:           "es09",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es09.jpg",
		},
		{
			ID:           "es10",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es10.jpg",
		},
		// Espadas — Cavaliere (Page)
		{
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/esnk.jpg",
		},
		// Espadas — Rei
		{
			ID:           "esrk",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/esrk.jpg",
		},
		// Espadas — Rainha
		{
			ID:           "esrq",
			...
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/esrq.jpg",
		},
		...
		// ---- ESPADAS (Swords) - Intelecto, conflito, verdades ----
		{
			...
			Suit:         "swords",
			ValueInt:     1,
			MeaningUpPT:  "Claridade mental, insight, verdade, novidade intelectual, poder da razão, comunicação.",
			MeaningRevPT: "Confusão mental, ilusão, demência, falta de clareza, pensamento obscurecido.",
			DescPT:       "Uma mão entre nuvens segurando uma espada. Claridade mental, insight, verdade, novidade intelectual.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es01.jpg",
		},
		{
			ID:           "es02",
			...
			Suit:         "swords",
			ValueInt:     2,
			MeaningUpPT:  "Decisão difícil, equilíbrio tenso, impasse, escolha entre dois mal, paralisia intelectual.",
			MeaningRevPT: "Decisão fora do impasse, neutralidade, consenso, fuga do conflito, resolução.",
			DescPT:       "Uma figura cega com duas espadas cruzadas sobre o mar. Decisão difícil, equilíbrio tenso.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es02.jpg",
		},
		{
			ID:           "es03",
			...
			Suit:         "swords",
			ValueInt:     3,
			MeaningUpPT:  "Dor, sofrimento, luto, ferimento emocional, ruptura, tristeza profunda, conflito doloroso.",
			MeaningRevPT: "Cicatrização, melhora, superação da dor, perda recuperada, fim do sofrimento.",
			DescPT:       "Três espadas cruzadas em um coração, com nuvens de tempestade. Dor, sofrimento, luto, ferimento emocional.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es03.jpg",
		},
		{
			ID:           "es04",
			...
			Suit:         "swords",
			ValueInt:     4,
			MeaningUpPT:  "Repouso, paz mental, retiro, recuperação, quietude, dessas, contemplação, férias.",
			MeaningRevPT: "Início de nova ação, atividade, impaciência, adiamento, falta de descanso.",
			DescPT:       "Uma figura de dressed eclesiástico em uma capela, com três espadas no chão. Repouso, paz mental.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es04.jpg",
		},
		{
			ID:           "es05",
			...
			Suit:         "swords",
			ValueInt:     5,
			MeaningUpPT:  "Confliito, derrota, rivalidade, humilhação, expulsão, ataque, inveja, batalha vencida.",
			MeaningRevPT: "Vitória, reconciliação, sucesso, paz após a batalha, superação do conflito.",
			DescPT:       "Três cavaleiros com espadas, um fugindo com uma bandeira murcha. Conflito, derrota, rivalidade.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es05.jpg",
		},
		{
			ID:           "es06",
			...
			Suit:         "swords",
			ValueInt:     6,
			MeaningUpPT:  "Transição, viagem, mudança, superação, passagem, renovação mental, adaptação.",
			MeaningRevPT: "Imobilidade, resistência à mudança, recusa da transição, boia, aderência ao passado.",
			DescPT:       "Um barco com passageiros entre montanhas geladas, com espadas cruzadas. Transição, viagem, mudança.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es06.jpg",
		},
		{
			ID:           "es07",
			...
			Suit:         "swords",
			ValueInt:     7,
			MeaningUpPT:  "Fraude, traição, deserção, estratégia, astúcia, invasão, espionagem, engano.",
			MeaningRevPT: "Estratégia bem-sucedida, competência, vitória intelectual, honra, ação corajosa.",
			DescPT:       "Um homem corre pegando sete espadas enquanto o exército foge. Fraude, traição, estratégia.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es07.jpg",
		},
		{
			ID:           "es08",
			...
			Suit:         "swords",
			ValueInt:     8,
			MeaningUpPT:  "Limitação, restrição, crise mental, angústia, experiência traumática, autoimposição.",
			MeaningRevPT: "Libertação gradual, superação da crise, possibilidade de escape, aceitação externa.",
			DescPT:       "Uma mulher amarrada com oito espadas, com um palhaço e um cubo. Limitação, crise mental, angústia.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es08.jpg",
		},
		{
			ID:           "es09",
			...
			Suit:         "swords",
			ValueInt:     9,
			MeaningUpPT:  "Ansiedade, temor, nightmare, sofrimento mental, culpa, angústia, tirania interna.",
			MeaningRevPT: "Superação do medo, libertação mental, desapego da culpa, tranquilidade interior.",
			DescPT:       "Um homem deitado em cama, com nove espadas no quarto, olhando um dragão. Ansiedade, temor, nightmare.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es09.jpg",
		},
		{
			ID:           "es10",
			...
			Suit:         "swords",
			ValueInt:     10,
			MeaningUpPT:  "Fim, crise terminal, desastre, fracasso, morte do pensamento, culpa, agonia.",
			MeaningRevPT: "Recuperação, início de novo ciclo, fim do sofrimento, superação, renovação.",
			DescPT:       "Um corpo com dez espadas no peito, olhando para o céu brilhante. Fim, crise, desastre, fracasso.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/es10.jpg",
		},
		// Espadas — Cavaliere (Page)
		{
			...
			Suit:         "swords",
			ValueInt:     0,
			MeaningUpPT:  "Mensageiro intelectual, jovem ativo, comunicação, inquietação, iniciação mental.",
			MeaningRevPT: "Mensagem confusa, inquietação mal direcionada, agitação, desinformação.",
			DescPT:       "Um jovem cavaleiro com uma espada, olhando para a esquerda. Mensageiro intelectual, jovem ativo.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/esnk.jpg",
		},
		// Espadas — Rei
		{
			...
			Suit:         "swords",
			ValueInt:     0,
			MeaningUpPT:  "Intelecto lúcido, justiça, autoridade mental, controle, lógica, independência, decisão.",
			MeaningRevPT: "Controlador, frieza, crueldade, inteligência manipuladora, ambição desmedida.",
			DescPT:       "Um rei sentado com espadas, olhos penetrantes, vestes pretas. Intelecto lúcido, justiça, autoridade.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/esrk.jpg",
		},
		// Espadas — Rainha
		{
			...
			Suit:         "swords",
			ValueInt:     0,
			MeaningUpPT:  "Inteligência lúcida, independência, clareza, justiça, astúcia, compreensão, coragem.",
			MeaningRevPT: "Manipulação, desconfiança excessiva, crueldade, frieza emocional, cinismo, inveja.",
			DescPT:       "Uma rainha sentada com espadas, um pássaro na mão. Inteligência lúcida, independência, clareza.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/esrq.jpg",
		},
		// ---- OU ROS (Pentacles) - Material, trabalho, prosperidade ----
		{
			...
			Suit:         "pentacles",
			ValueInt:     1,
			MeaningUpPT:  "Novo início material, riqueza, oportunidade, prosperidade, investimento, sucesso, abundância.",
			MeaningRevPT: "Perda financeira, mau investimento, estagnação, insucesso material, barreiras econômicas.",
			DescPT:       "Uma mão celeste derramando moedas de ouro sobre um altar. Novo início material, riqueza, oportunidade.",
			ImageURL:     "https://cdn.jsdelivr.net/gh/jamile-dev/lets-tarot@main/cards/ou01.jpg",
		},
		{
			ID:           "ou02",

    ...
    <>
      ...
      <section className="hero-section" aria-labelledby="hero-title">
        <div className="hero-content">
          ...
          <h1 id="hero-title" className="hero-title">Lets-Tarot</h1>
          ...
          <div className="btn-group-hero">
            <button
              ...
              aria-label="Começar agora — criar conta"
            >
              Começar agora 🚀
            </button>
            <button
      ...
      {/* Features Section */}
      <section className="features-section" aria-label="Recursos principais">
      ...
      <section className="howto-section" aria-labelledby="howto-title">
        <h2 id="howto-title" className="howto-title">Como funciona</h2>
        <div className="howto-steps">
          <div className="howto-step">
            <span className="step-number" style={{ background: 'var(--gold)' }} aria-hidden="true">1</span>
            <div>
          ...
          <div className="howto-step">
            <span className="step-number" style={{ background: 'var(--purple)' }} aria-hidden="true">2</span>
            <div>
          ...
          <div className="howto-step">
            <span className="step-number" style={{ background: 'var(--green)' }} aria-hidden="true">3</span>
            <div>
